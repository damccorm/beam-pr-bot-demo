...
async function getPullsFromLastYear(): Promise<any[]> {
...
// Basically, just looking for the first comment, approval, or merge that isn't
// (a) the author
// (b) automated tooling
// and comparing that to the creation time.
...
// Looking for comments tagging reviewers and comparing to the merge time.
...
async function gatherMetrics() {
  ...
  const pullsFromLastYear = await getPullsFromLastYear();
